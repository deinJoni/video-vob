...
1. **Read `.opencode/vob/references/editorial-patterns.md` first** — it is the rubric you score against (the seven dimensions, the grounding cheat-sheet, the cold-open/retention recipes, the `editorial/*` finding codes, the per-ruleset emphasis). Score against THAT doc, not your own taste.
