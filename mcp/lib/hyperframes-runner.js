...
function runHyperframesBlocking(subArgv, { cwd, timeoutMs = RENDER_TIMEOUT_MS } = {}) {
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      reject(new ToolError(
        ERROR_CODES.INTERNAL_ERROR,
        `npx hyperframes spawn failed: ${error.message || String(error)}. ${HYPERFRAMES_INSTALL_HINT}`,
      ));
      return;
    }
