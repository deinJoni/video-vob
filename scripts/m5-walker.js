...
// `variety`, `hook`, `visualqc`, `designprofile`, and `highlights` (source-free unit
// harnesses) need no source video — every other phase lays out a fixture against a real clip.
if (!SOURCE && !["stillsqc", "spans", "editorial", "takequality", "variety", "hook", "visualqc", "designprofile", "highlights"].includes(process.argv[2])) {
  console.error(
