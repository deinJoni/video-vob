...
- `data-media-start` — the timestamp INSIDE the source file where playback should begin (maps to storyboard `in_seconds`).
...
HTML rendition (assuming scene starts at t=2.0):
```html
<!-- Scene s002 — beat -->
<div class="clip"
     data-start="2.0"
