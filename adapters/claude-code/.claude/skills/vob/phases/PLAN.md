...
4b. **Highlight extraction — auto-author the fan-out (v0.3.11).** When
   ...
   long or already-edited source), call `mcp__vob__vob_propose_highlights { project_id }` BEFORE the
